...
function a$1(t2) {
  !function(e) {
    ...
    t2.setEditorState(o(t2, n2)), t2.dispatchCommand(lexical.CLEAR_HISTORY_COMMAND, void 0);
  });
}
...
const FlashMessageContext = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Context$1.Provider, { value: showFlashMessage, children: [
    children,
...
class ue extends lexical.ElementNode {
  static getType() {
    return "tablecell";
  }
  static clone(e) {
...
function he(e) {
  ...
  return { after: (e2) => (0 === e2.length && e2.push(lexical.$createParagraphNode()), e2), forChild: (e2, t3) => {
    if (ge(t3) && !lexical.$isElementNode(e2)) {
      const t4 = lexical.$createParagraphNode();
      return lexical.$isLineBreakNode(e2) && "\n" === e2.getTextContent() ? null : (lexical.$isTextNode(e2) && (c && e2.toggleFormat("bold"), a2 && e2.toggleFormat("strikethrough"), u && e2.toggleFormat("italic"), h && e2.toggleFormat("underline")), t4.append(e2), t4);
    }
    return e2;
  }, node: r };
}
function de(e = ae.NO_STATUS, t2 = 1, n2) {
  return lexical.$applyNodeReplacement(new ue(e, t2, n2));
}
function ge(e) {
  return e instanceof ue;
}
lexical.createCommand("INSERT_TABLE_COMMAND");
function me(e) {
...
class Se extends lexical.ElementNode {
  static getType() {
    return "tablerow";
  }
  static clone(e) {
  ...
  createDOM(t2) {
    ...
    return this.__height && (n2.style.height = `${this.__height}px`), utils.addClassNamesToElement(n2, t2.theme.tableRow), n2;
  }
...
function Ce(e) {
  const n2 = e;
  let o2;
  return ce.test(n2.style.height) && (o2 = parseFloat(n2.style.height)), { after: (e2) => utils.$descendantsMatching(e2, ge), node: _e(o2) };
}
function _e(e) {
  return lexical.$applyNodeReplacement(new Se(e));
}
function we(e) {
...
function ze(e) {
  ...
  if (e instanceof ue) t2 = e;
    ...
    const o3 = utils.$findMatchingParent(e, ge);
    ge(o3) || pe(148), t2 = o3;
  } else {
    const o3 = utils.$findMatchingParent(e.getNode(), ge);
    ge(o3) || pe(148), t2 = o3;
  }
...
function Xe(e) {
  const [[t2, o2, r, l], [s, i2, c, a2]] = ["anchor", "focus"].map((t3) => {
    const o3 = e[t3].getNode(), r2 = utils.$findMatchingParent(o3, ge);
...
class je {
  ...
  clone() {
    return new je(this.tableKey, lexical.$createPoint(this.anchor.key, this.anchor.offset, this.anchor.type), lexical.$createPoint(this.focus.key, this.focus.offset, this.focus.type));
  }
  isCollapsed() {
    return false;
  }
  ...
  hasFormat(e) {
    ...
    this.getNodes().filter(ge).forEach((e2) => {
      ...
      lexical.$isParagraphNode(n3) && (t2 |= n3.getTextFormat());
    });
    const n2 = lexical.TEXT_TYPE_TO_FORMAT[e];
    return !!(t2 & n2);
  }
  insertNodes(e) {
    const t2 = this.focus.getNode();
    lexical.$isElementNode(t2) || pe(151);
    lexical.$normalizeSelection__EXPERIMENTAL(t2.select(0, t2.getChildrenSize())).insertNodes(e);
  }
  getShape() {
  ...
  getNodes() {
    ...
    return lexical.isCurrentlyReadOnlyMode() || (this._cachedNodes = f), f;
  }
  getTextContent() {
...
function Qe(e, t2) {
  ...
  for (let e2 = n2.at(-1); void 0 !== e2 && n2.length > 0; e2 = n2.at(-1)) {
    const o2 = e2.pop();
    void 0 === o2 ? n2.pop() : false !== t2(o2) && lexical.$isElementNode(o2) && n2.push(o2.getChildren());
  }
}
function lt(e, t2) {
...
function Kt(e, t2, n2) {
  return lt(e, lexical.$getNearestNodeFromDOMNode(t2, n2));
}
...
function At(t2, n2, r) {
  r ? (utils.addClassNamesToElement(t2, n2.theme.tableRowStriping), t2.setAttribute("data-lexical-row-striping", "true")) : (utils.removeClassNamesFromElement(t2, n2.theme.tableRowStriping), t2.removeAttribute("data-lexical-row-striping"));
}
const $t = /* @__PURE__ */ new WeakSet();
function Ht(e = lexical.$getEditor()) {
  return $t.has(e);
}
class Pt extends lexical.ElementNode {
  static getType() {
    return "table";
  }
  getColWidths() {
  ...
  createDOM(t2, n2) {
    ...
    if (o2.appendChild(r), Mt(o2, 0, this.getColumnCount(), this.getColWidths()), lexical.setDOMUnmanaged(r), utils.addClassNamesToElement(o2, t2.theme.table), this.__rowStriping && At(o2, t2, true), Ht(n2)) {
      const n3 = document.createElement("div"), r2 = t2.theme.tableScrollableWrapper;
      return r2 ? utils.addClassNamesToElement(n3, r2) : n3.style.cssText = "overflow-x: auto;", n3.appendChild(o2), n3;
    }
    return o2;
  }
  updateDOM(e, t2, n2) {
  ...
  exportDOM(e) {
    ...
    return { after: (e2) => {
      if (t2.after && (e2 = t2.after(e2)), utils.isHTMLElement(e2) && "TABLE" !== e2.nodeName && (e2 = e2.querySelector("table")), !utils.isHTMLElement(e2)) return null;
      ...
      return e2;
    }, element: utils.isHTMLElement(n2) && "TABLE" !== n2.nodeName ? n2.querySelector("table") : n2 };
  }
  canBeEmpty() {
    return false;
  }
  ...
  getCellNodeFromCords(e, t2, n2) {
    ...
    const r = lexical.$getNearestNodeFromDOMNode(o2.elem);
    return ge(r) ? r : null;
  }
...
function Bt(e) {
  ...
  return { after: (e2) => utils.$descendantsMatching(e2, we), node: n2 };
}
function Dt() {
  return lexical.$applyNodeReplacement(new Pt());
}
function It(e) {
  return e instanceof Pt;
}
const EquationComponent = React__namespace.lazy(() => Promise.resolve().then(() => require("./EquationComponent-BsvrIJmN.js")));
...
const ImageComponent = React__namespace.lazy(() => Promise.resolve().then(() => require("./ImageComponent-Bb29LKuV.js")));
  ...
  React.useEffect(() => {
    docFromHash(window.location.hash).then((doc) => {
      if (doc && doc.source === "Playground") {
        ...
        editor.dispatchCommand(lexical.CLEAR_HISTORY_COMMAND, void 0);
      }
    });
  }, [editor]);
  React.useEffect(() => {
  ...
  const handleMarkdownToggle = React.useCallback(() => {
    editor.update(() => {
      ...
      if (code.$isCodeNode(firstChild) && firstChild.getLanguage() === "markdown") {
        ...
        const markdown$1 = markdown.$convertToMarkdownString(
          PLAYGROUND_TRANSFORMERS,
          void 0,
          //node
          shouldPreserveNewLinesInMarkdown
        );
        const codeNode = code.$createCodeNode("markdown");
        codeNode.append(lexical.$createTextNode(markdown$1));
        root.clear().append(codeNode);
        if (markdown$1.length === 0) {
          codeNode.select();
        }
      }
    });
  }, [editor, shouldPreserveNewLinesInMarkdown]);
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "actions", children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx("i", { className: "import" })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx("i", { className: "export" })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx("i", { className: "share" })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        ...
        onClick: () => {
          showModal(
            ...
            (onClose) => /* @__PURE__ */ jsxRuntime.jsx(ShowClearDialog, { editor, onClose })
          );
        },
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx("i", { className: "clear" })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx("i", { className: !isEditable ? "unlock" : "lock" })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx("i", { className: "markdown" })
      }
    ),
    modal
  ] });
...
function ShowClearDialog({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "Modal__content", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        Button,
        {
          onClick: () => {
  ...
  return [
    ...
    ...[3, 4, 5].map(
      (n2) => new ComponentPickerOption(`Heading ${n2}`, {
        icon: /* @__PURE__ */ jsxRuntime.jsx("i", { className: `icon h${n2}` }),
        keywords: ["heading", "header", `h${n2}`],
        onSelect: () => editor.update(() => {
          const selection$1 = lexical.$getSelection();
          if (lexical.$isRangeSelection(selection$1)) {
            selection.$setBlocksType(selection$1, () => richText.$createHeadingNode(`h${n2}`));
          }
        })
      })
    ),
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    LexicalTypeaheadMenuPlugin.LexicalTypeaheadMenuPlugin,
    {
      ...
      menuRenderFn: (anchorElementRef, { selectedIndex, selectOptionAndCleanUp, setHighlightedIndex }) => anchorElementRef.current && options.length ? ReactDOM__namespace.createPortal(
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "typeahead-popover component-picker-menu", children: /* @__PURE__ */ jsxRuntime.jsx("ul", { children: options.map((option, i2) => /* @__PURE__ */ jsxRuntime.jsx(
...
function DragDropPaste() {
  ...
  React.useEffect(() => {
    return editor.registerCommand(
      ...
      (files) => {
        (async () => {
          const filesResult = await utils.mediaFileReader(
            files,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    LexicalTypeaheadMenuPlugin.LexicalTypeaheadMenuPlugin,
    {
      ...
      menuRenderFn: (anchorElementRef, { selectedIndex, selectOptionAndCleanUp, setHighlightedIndex }) => anchorElementRef.current && results.length ? ReactDOM__namespace.createPortal(
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "typeahead-popover mentions-menu", children: /* @__PURE__ */ jsxRuntime.jsx("ul", { children: options.map((option, i2) => /* @__PURE__ */ jsxRuntime.jsx(
...
const clearFormatting = (editor) => {
  editor.update(() => {
    const selection2 = lexical.$getSelection();
    if (lexical.$isRangeSelection(selection2) || Ve(selection2)) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          DropDownItem,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "icon-text-container", children: [
                /* @__PURE__ */ jsxRuntime.jsx("i", { className: "icon h4" }),
                /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text", children: formatMessage({
                  id: "lexical.plugin.toolbar.block.h4",
                  defaultMessage: "Heading 4"
                }) })
              ] }),
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "shortcut", children: SHORTCUTS.HEADING4 })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsxs(
          DropDownItem,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "icon-text-container", children: [
                /* @__PURE__ */ jsxRuntime.jsx("i", { className: "icon h5" }),
                /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text", children: formatMessage({
                  id: "lexical.plugin.toolbar.block.h5",
                  defaultMessage: "Heading 5"
                }) })
              ] }),
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "shortcut", children: SHORTCUTS.HEADING5 })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsxs(
...
function ToolbarPlugin({
  ...
  const $updateToolbar = React.useCallback(() => {
    ...
    if (lexical.$isRangeSelection(selection$1)) {
      ...
      const tableNode = utils.$findMatchingParent(node, It);
      if (It(tableNode)) {
    ...
    if (lexical.$isRangeSelection(selection$1) || Ve(selection$1)) {
...
const StrapiImageComponent = React__namespace.lazy(() => Promise.resolve().then(() => require("./StrapiImageComponent-lHRMJ-f_.js")));
...
function $createStrapiImageNode({ documentId, src }) {
  return lexical.$applyNodeReplacement(new StrapiImageNode(documentId, src));
}
...
class n extends lexical.TextNode {
  static getType() {
    return "hashtag";
  }
  static clone(t2) {
  ...
  createDOM(e) {
    ...
    return utils.addClassNamesToElement(r, e.theme.hashtag), r;
  }
...
function a(t2 = "") {
  return lexical.$applyNodeReplacement(new n(t2));
}
...
const InlineImageComponent = React__namespace.lazy(() => Promise.resolve().then(() => require("./InlineImageComponent-Bx9SdgK3.js")));
...
const PollComponent = React__namespace.lazy(() => Promise.resolve().then(() => require("./PollComponent-BTN1pEKT.js")));
function createUID() {
...
const StickyComponent = React__namespace.lazy(() => Promise.resolve().then(() => require("./StickyComponent-BpjUPJFM.js")));
